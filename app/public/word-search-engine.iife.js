var WordSearchEngine=(function(){"use strict";typeof window<"u"&&((window.__svelte??={}).v??=new Set).add("5");let Et=!1,Vr=!1;function Yr(){Et=!0}Yr();const Nr=1,_r=2,Ti=4,kr=8,Sr=16,Rr=2,Hr=8,Jr=1,Fr=2,ei="[",ti="[!",Ki="[?",wn="]",Ut={},ee=Symbol(),te=Symbol("filename"),Ei="http://www.w3.org/1999/xhtml",zr=!0;var Wn=Array.isArray,jr=Array.prototype.indexOf,Bt=Array.prototype.includes,Bn=Array.from,Vn=Object.keys,we=Object.defineProperty,ut=Object.getOwnPropertyDescriptor,Ui=Object.getOwnPropertyDescriptors,Dr=Object.prototype,Lr=Array.prototype,ni=Object.getPrototypeOf,$i=Object.isExtensible;const tt=()=>{};function Or(e){return e()}function Yn(e){for(var t=0;t<e.length;t++)e[t]()}function Pi(){var e,t,n=new Promise((i,l)=>{e=i,t=l});return{promise:n,resolve:e,reject:t}}const P=2,$t=4,an=8,Qi=1<<24,dt=16,Fe=32,Ct=64,ii=128,We=512,L=1024,ie=2048,ze=4096,Ae=8192,Be=16384,ft=32768,li=1<<25,Pt=65536,Nn=1<<17,Mr=1<<18,Vt=1<<19,qi=1<<20,Ke=1<<25,Yt=65536,_n=1<<21,kn=1<<22,bt=1<<23,Ee=Symbol("$state"),el=Symbol("legacy props"),Tr=Symbol(""),tl=Symbol("proxy path"),nt=new class extends Error{name="StaleReactionError";message="The reaction that called `getAbortSignal()` was re-run or destroyed"},nl=!!globalThis.document?.contentType&&globalThis.document.contentType.includes("xml"),Kr=1,gn=3,Qt=8,Er=11;function Ur(e){{const t=new Error(`invariant_violation
