    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <StatCard
          icon="stacks"
          color="blue"
          value={loading ? "—" : String(totalGames)}
          label="Total Games"
        />
        <StatCard
          icon="check_circle"
        ...
        <StatCard
          icon="edit_note"
          color="orange"
          value={loading ? "—" : String(totalGames - publishedCount)}
          label="Drafts"
        />
      </div>
      ...
      {loading ? (
        <div className="bg-white border border-[#e2e8f0] rounded-xl p-12 text-center text-[#64748b]">
          <span className="material-symbols-outlined animate-spin text-3xl mb-2 block">
            progress_activity
          </span>
          Loading games…
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <GameSection
            ...
            type="sudoku"
            onAdd={() =>
              setModal({ open: true, mode: "create", type: "sudoku" })
            }
            onEdit={(g) =>
              setModal({
                open: true,
